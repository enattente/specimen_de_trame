function init_interface_seuil() {
  ...
  let slider_brightness, niveaux_brightness, miniatures_brightness;
  ...
  p.setup = () => {
    ...
    slider_x_start = 0;
    slider_y_start = p.height/2;
    slider_x_end = p.width;
    slider_y_end = p.height/2;

    miniatures_x_left = 0;
    miniatures_y_top = 0;
    miniatures_x_right = p.width;
    miniatures_y_bottom = p.height/2;

    niveaux_x_left = 0, 
    niveaux_y_top = p.height/2, 
    niveaux_x_right = p.width, 
    niveaux_y_bottom = p.height;
