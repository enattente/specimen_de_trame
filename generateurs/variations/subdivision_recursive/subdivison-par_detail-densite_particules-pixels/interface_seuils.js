function init_interface_seuil() {
  ...
  p.setup = () => {
    ...
    niveaux_1 = new Niveau(p, niveaux_x_left_1, niveaux_y_top_1, niveaux_x_right_1, niveaux_y_bottom_1, rules_nb_particules, map_image_brightness);
    ...
    miniatures_1 = new Miniatures(p, miniatures_x_left_1, miniatures_y_top_1, miniatures_x_right_1, miniatures_y_bottom_1, nb_value_colors, map_image_brightness, rules_nb_particules, slider_1);
  ...
  p.mouseDragged = function() {
    ...
    if (selected_niveau_1 !== -1) {
      ...
      let value = p.map(y_clamped, niveaux_y_top_1, niveaux_y_bottom_1, rules_nb_particules.rules_max, rules_nb_particules.rules_min);
      value = p.int(value);
      rules_nb_particules .update_one_rule(selected_niveau_1, value)  
    }
