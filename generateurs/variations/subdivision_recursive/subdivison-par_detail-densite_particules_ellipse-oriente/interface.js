function init_interface() {
  ...
  // Nombre de value detail
  const nbValueInputDetail = document.getElementById('nb-value-input-detail');
  nbValueInputDetail.value = nb_value_detail;
  nbValueInputDetail.addEventListener('input', () => {
    nb_value_detail = parseInt(nbValueInputDetail.value);
    map_image_detail.update_nb_value(nb_value_detail);
    rules_division.update_nb_rules(nb_value_detail);
    make_miniatures();
  });

  // Nombre de value brightness
  const nbValueInputBrightness = document.getElementById('nb-value-input-brightness');
  nbValueInputBrightness.value = nb_value_colors;
  nbValueInputBrightness.addEventListener('input', () => {
    nb_value_colors = parseInt(nbValueInputBrightness.value);
