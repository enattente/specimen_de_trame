function init_interface_seuil() {
  ...
  p.setup = () => {
    ...
    niveaux_brightness = new Niveau(p, niveaux_x_left, niveaux_y_top, niveaux_x_right, niveaux_y_bottom, rules_colors, map_image_brightness);
  ...
  p.mouseDragged = function() {
    ...
    if (selected_niveau !== -1) {
      ...
      let value = p.map(y_clamped, niveaux_y_top, niveaux_y_bottom, rules_colors.rules_max, rules_colors.rules_min);
      value = p.int(value);
      rules_colors.update_one_rule(selected_niveau, value)  
    }
