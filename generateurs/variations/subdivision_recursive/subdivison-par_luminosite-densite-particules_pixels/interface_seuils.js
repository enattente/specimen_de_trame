function init_interface_seuil() {
  ...
  p.setup = () => {
    ...
    miniatures_brightness = new Miniatures(p, miniatures_x_left, miniatures_y_top, miniatures_x_right, miniatures_y_bottom, nb_value_colors, map_image_brightness, rules_division, slider_brightness);
