function init_interface() {
  ...
  nbValueInput.addEventListener('input', () => {
    ...
    rules_state_vertical.update_nb_rules(nb_value_colors);
    make_miniatures();
  });

  // line thickness
  const lineThicknessInput = document.getElementById('line-thickness-input');
  lineThicknessInput.value = line_thickness;
  lineThicknessInput.addEventListener('input', () => {
    line_thickness = parseInt(lineThicknessInput.value);
